<footer class="footer">
  <div class="footer__grid">
    <div class="footer__contenido">
      <h3 class="footer__logo">&lt;DevWebCamp&sol;&gt;</h3>
      <p class="footer__texto">DevWebCamp es una conferencia para desarrolladores de todos los niveles. Se lleva a cabo de forma presencia y en línea</p>
    </div>
  ...
  <p class="footer__copyright">&lt;DevWebCamp&sol;&gt;<span class="footer__copyright--regular">&ThickSpace;&dash;&ThickSpace;Todos los derechos reservados&copy;&ThickSpace;<?php echo date('Y'); ?></span></p>
</footer>